...
const Blog = () => {
    ...
    const downloadPDF = () => {
        const capture = document.querySelector('.main-blog')
        setLoader(true);
    ...
    return (
        <div>
            <div className="head d-flex align-items-center">
                <h1 className='text-center text-decoration-underline mt-3 mx-auto'>Blogs</h1>
                <button
                    className="receipt-modal-download-button btn btn-warning mx-3"
                    onClick={downloadPDF}
